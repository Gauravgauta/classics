...
if (isset($_POST['register'])) {
    ...
    $query = "INSERT INTO reservations (email, name, phone, hotel, room_type, checkin_date, checkout_date, adults, children, arrival_time, message)
              VALUES (?, ?, ?, ?, ?, ?, ?, ?, ?, ?, ?)";
    $stmt = $conn->prepare($query);
    $stmt->bind_param("sssssssiiis", $email, $name, $phone, $hotel, $room_type, $checkin_date, $checkout_date, $adults, $children, $arrival_time, $message);
